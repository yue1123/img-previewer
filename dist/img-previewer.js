    ...
    function ImgPreviewer(selector, options) {
        ...
        function render() {
            ...
            if (!el) {
                ...
                previewerContainer.style.setProperty('--container-opcity:', '0.7');
                previewerContainer.style.setProperty('--container-opcity:', '0.2');
        ...
        function _init(selector, options) {
            ...
            console.log(store.imgEls);
            // init listen index
            (function (value) {
                Object.defineProperty(store, 'index', {
                    enumerable: false,
                    set: function (newVal) {
                        onIndexChange(value = newVal);
                    },
                    get: function () {
                        console.log('获取');
                        return value;
