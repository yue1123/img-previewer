...
const m = 'button'
let template = `
        <${n} class="img-pre__header img-pre__animated">
            <${n} class="img-pre__nums">
                <p>
            ...
            <${n} class="img-pre__bottons" id="J_header-buttons">
                <${m} class="img-pre__button-item" data-action="reset" data-tooltip="{{RESET}}">
                ...
                <${m} class="img-pre__button-item" data-action="rotateLeft" data-tooltip="{{ROTATE_LEFT}}">
                ...
                <${m} class="img-pre__button-item" data-action="rotateRight" data-tooltip="{{ROTATE_RIGHT}}">
                ...
                <${m} class="img-pre__button-item" data-action="close" data-tooltip="{{CLOSE}}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16" > <path fill-rule="evenodd" d="M13.854 2.146a.5.5 0 0 1 0 .708l-11 11a.5.5 0 0 1-.708-.708l11-11a.5.5 0 0 1 .708 0Z" /> <path fill-rule="evenodd" d="M2.146 2.146a.5.5 0 0 0 0 .708l11 11a.5.5 0 0 0 .708-.708l-11-11a.5.5 0 0 0-.708 0Z" /> </svg>
                </${m}>
                <${m} id="J-img-pre__prev" data-action="prev" data-tooltip="{{PREV}}">
                ...
                <${m} id="J-img-pre__next" data-action="next" data-tooltip="{{NEXT}}">
        ...
        <${n} class="img-pre__contet-warpper" id="J_content-warpper">
            <${n} class="img-pre__img-item img-pre__animated current-index" id="J_current-index">
